...
if __name__ == "__main__":
    ...
    categorical_features = ['model_key','fuel','paint_color', 'car_type', 'private_parking_available', 'has_gps','has_air_conditioning', 'automatic_car', 'has_getaround_connect','has_speed_regulator', 'winter_tires'] # Names of categorical columns in X_train/X_test
    ...
    # mlflow.set_tag("developer", "marie")
